...
import com.example.myapplication.adapter.AreaAdapter;
import com.example.myapplication.R;
import com.example.myapplication.data.Area;
import com.example.myapplication.databinding.FragmentStoryAreaBinding;
...
public class StoryareaFragment extends BaseFragment implements AreaAdapter.OnItemClickListener  {

    private FragmentStoryAreaBinding binding;
    ...
    public static StoryareaFragment newInstance() {
        return new StoryareaFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = FragmentStoryAreaBinding.inflate(inflater);
        ...
        request.enqueue(new Callback<List<Area>>() {
            ...
            public void onResponse(Call<List<Area>> call, Response<List<Area>> response) {
                ...
                if(response.code() == 200) {
                    ...
                    adapter = new AreaAdapter((ArrayList<Area>) areas, StoryareaFragment.this::onItemClick);
