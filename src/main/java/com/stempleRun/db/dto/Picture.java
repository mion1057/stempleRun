...
public class Picture {
   ...
   @SequenceGenerator(sequenceName = "PICTURE_SEQ", allocationSize = 1, name = "CUST_SEQ")
   private int pic_num;
   ...
   @CreationTimestamp // 날짜 시간 가지고 오기!
   private LocalDate pic_date;
   ...
   public LocalDate getPic_date() {
      return pic_date;
   }

   public void setPic_date(LocalDate pic_date) {
